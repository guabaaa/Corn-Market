...
window.addEventListener("load", function () {
    ...
    // data
    let select = { 최신글: ["선택없음"], 카테고리: ["선택하세요", "전자기기", "가구,인테리어", "의류", "뷰티,미용", "취미,게임,음반", "반려동물용품", "기타"], 지역: ["강남구", "강동구", "강서구", "강북구", "관악구", "광진구", "구로구", "금천구", "노원구", "동대문구", "도봉구", "동작구", "마포구", "서대문구", "성동구", "성북구", "서초구", "송파구", "영등포구", "용산구", "양천구", "은평구", "종로구", "중구", "중랑구"] }
