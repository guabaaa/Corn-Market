...
<html>
  ...
  <body>
    ...
    <script>
      var locationInfo = geoFindMe(); //위치 정보
      console.log(locationInfo);
      var latitudeInfo = 37.7230785;
      var longitudeInfo = 126.7496159;
      console.log(typeof(latitudeInfo));
      
      //Kakao Maps API 좌표로 주소를 얻어내기
      var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
      mapOption = {
          center: new kakao.maps.LatLng(latitudeInfo, longitudeInfo), // 지도의 중심좌표
          level: 1 // 지도의 확대 레벨
      };  
